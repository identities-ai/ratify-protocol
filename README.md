...
```bash
cargo add ratify-protocol@1.0.0-alpha.19
```
...
|---|---|---|---|
| `github.com/identities-ai/ratify-protocol` | Go | ✅ 79/79 | `go get github.com/identities-ai/ratify-protocol@v1.0.0-alpha.19` |
| `@identities-ai/ratify-protocol` | TypeScript | ✅ 79/79 | `npm install @identities-ai/ratify-protocol` |
| `ratify-protocol` | Python | ✅ 79/79 | `pip install ratify-protocol==1.0.0a19` |
| `ratify-protocol` | Rust | ✅ 79/79 | `cargo add ratify-protocol@1.0.0-alpha.19` |
