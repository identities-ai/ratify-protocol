...
An implementation is conformant if, for every fixture in `testvectors/v1/*.json` (79 fixtures as of the v1.0.0-alpha.18 conformance set; alpha.15 had 63):
...
*v1.0.0-alpha.18 · Identities AI · CC-BY-4.0 · Patent Pending*
