...
Architecture, threat model, and open questions for NVIDIA engineers: [`docs/nvidia-open-secure-ai-reference-proposal.md`](https://github.com/identities-ai/ratify-protocol/blob/main/docs/nvidia-open-secure-ai-reference-proposal.md). Full evidence, hashes, and known limitations: [`docs/evidence/nvidia-reference-evidence.md`](https://github.com/identities-ai/ratify-protocol/blob/main/docs/evidence/nvidia-reference-evidence.md).
