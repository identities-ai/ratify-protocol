...
Exercises the protocol primitives in each SDK against the 63 canonical test vectors.
...
**Pass criterion:** all five print green, all 63 fixtures pass in every language.
