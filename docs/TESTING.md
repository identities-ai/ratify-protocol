...
Exercises the protocol primitives in each SDK against the 78 canonical test vectors.
...
**Pass criterion:** all five print green, all 78 fixtures pass in every language.
