...
**Status:** Normative as of v1.0.0-alpha.6 (SPEC §5.14, §6.4.7). Implemented in Go, TypeScript, Python, Rust, and C/C++. Five canonical fixtures prove the envelope and tamper cases.
