...
The reference works today against the released NOOA package and a pinned OpenShell gateway, with adversarial denial cases as executable tests. We're not asking for endorsement, just the right contacts and one review session.

Could you route us to the Alliance owner for identity and permissions, and the appropriate NOOA lead?
