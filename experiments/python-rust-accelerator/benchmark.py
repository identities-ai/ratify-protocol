...
python_stats = measure(lambda: verify_bundle(python_bundle, python_options))
native_cached_stats = measure(lambda: verify_bundle_json(bundle_json, options_json))
native_api_stats = measure(lambda: verify_bundle_json(encode_proof_bundle(python_bundle), options_json))
native_object_stats = measure(lambda: verify_bundle_object(python_bundle, options_json))
