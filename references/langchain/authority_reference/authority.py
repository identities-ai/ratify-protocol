...
The root delegates to an LangChain commander. The commander narrows that authority
...
NODE_LIMIT_CONSTRAINT = "ai.identities.ratify.langchain.max_nodes"
...
def issue_authority(
    *,
    ...
    commander, commander_private = generate_agent("LangChain Commander", "custom")
