...
Byte-identical interoperability with the Go, TypeScript, Python, and Rust reference implementations. Validated against the **62 canonical test vectors** on every CI run.
...
The C SDK is validated against the same 62 canonical cross-language test
...
# Conformance tests (62/62 fixtures)
