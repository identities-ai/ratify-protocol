...
Byte-identical interoperability with the TypeScript, Python, Rust, and C reference implementations. Validated against the **59 canonical test vectors** on every CI run.
