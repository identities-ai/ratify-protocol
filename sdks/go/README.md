...
Byte-identical interoperability with the TypeScript, Python, Rust, and C reference implementations. Validated against the **62 canonical test vectors** on every CI run.
